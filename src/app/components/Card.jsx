...
const Card = ({ movies }) => {
    return (
        <div className="cursor-pointer hover:z-30 transform hover:bg-slate-500 hover:scale-105 sm:hover:shadow-slate-400 sm:shadow-md rounded-lg sm:border sm:border-slate-400 sm:m-2 transition duration-300 sm:p-3 ">
            <Link href={`/movie/${movies.id}`}>
                <Image
                    ...
                    src={`https://image.tmdb.org/t/p/original/${movies.poster_path || movies.backdrop_path}`}/>
            </Link>
